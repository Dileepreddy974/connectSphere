      ...
      <div className="p-4 bg-slate-900/80 backdrop-blur-sm border-t border-slate-800">
        <form onSubmit={handleSendMessage} className="relative flex items-end gap-2">
          ...
          <button 
            ...
            className="bg-indigo-600 hover:bg-indigo-500 disabled:bg-slate-800 disabled:text-slate-600 text-white p-3 rounded-2xl transition-all shadow-lg active:scale-95"
          >
